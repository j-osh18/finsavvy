...
import Frames from '../assets/logos/frames.png'
  ...
  return (
    <section id='features' className='flex max-w-7xl flex-col gap-10 px-8 pt-10 lg:px-12 xl:m-auto xl:pt-20'>
        <article className='m-auto w-{30ch} text-center text-gray-500 md:m-0 md:w-full'>
            <h2 className='mb-4 text-4xl font-semibold text-gray-800'>Make every coin count</h2>
            <p>Paying using Finsavvy has never been easier <br />
             Whether you are paying for internet or subscriptions, Finsavvy gets it done.
            </p>
        </article>
        ...
        <article className='flex w-full flex-col gap-8 overflow-hidden xl:h-96 xl:flex-row '>
            <div className='flex flex-col rounded-2xl bg-sky-100 px-4 sm:px-0 md:flex-row md:gap-8 xl:w-2/3'>
                <div className='mt-10 flex flex-col justify-center gap-4 text-center sm:mx-10 md:mx-0 md:ml-10 md:w-1/2 md:text-left'>
                    <h2 className='m-auto text-center text-3xl font-semibold text-gray-800 sm:{18ch} md:m-0 md:text-left'>Pay with Finsavvy</h2>
                    <p className='m-auto text-center text-gray-500 sm:w-{34ch} md:m-0 md:text-left'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nisi soluta est voluptatum, natus itaque neque eveniet architecto nobis rerum iste, fugiat eligendi perferendis illo laborum quidem. Excepturi dolorum vero saepe.</p>
                </div>

                <div className='m-auto mt-10 max-w-72 md:mx-10 m:w-1/2 lg:mx-0'>
                    <img src={AppFrame} alt='finsavvy' />
                </div>
            </div>
            ...
            <div className='flex flex-col justify-center gap-4 rounded-2xl bg-indigo-100 p-10 xl:w-1/3'>
                ...
                <p className='text-gray-500'>Your Money is 100% secure on Finsavvy.</p>
            </div>
        </article>

        {/* Swapped cards in the second row */}
        <article className='flex w-full flex-col gap-8  xl:h-96 xl:flex-row '>
            <div className='flex flex-col justify-center gap-4 rounded-2xl bg-orange-100 p-10 xl:w-1/3'>
                <div className='w-fit rounded-full bg-orange-200 p-4'>
                    <img src={Coins} alt='shield check' />
                </div>
                <h2 className='text-3xl font-semibold text-gray-800'>Cost reduction</h2>
                <p className='text-gray-500'>Finsavvy reuced payments, maintenance and procesing fees.</p>
            </div>
            ...
            <div className='flex flex-col gap-8 overflow-hidden rounded-2xl bg-sky-100 px-4 sm:px-0 md:flex-row md:gap-8 xl:w-2/3'>
                <div className='mt-10 flex flex-col justify-center gap-4 text-center sm:mx-10 md:mx-0 md:ml-10 md:w-1/2 md:text-left md:mt-0'>
                    <h2 className='m-auto text-center text-3xl font-semibold text-gray-800 sm:{18ch} md:m-0 md:text-left'>Send, receive and exchange money.</h2>
                    <p className='m-auto text-center text-gray-500 sm:w-{34ch} md:m-0 md:text-left'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nisi soluta est voluptatum, natus itaque neque eveniet architecto nobis rerum iste, fugiat eligendi perferendis illo laborum quidem. Excepturi dolorum vero saepe.</p>
                </div>

                <div className='m-auto max-w-96 md:w-1/2 md:mt-36'>
                    <img src={Frames} alt='frame displaying' />
                </div>
            </div>
        </article>
    </section>
